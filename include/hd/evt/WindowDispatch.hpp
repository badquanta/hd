...
#include "hd/evt/DropDispatch.hpp"
namespace hd::evt {
    class WindowDispatch : public SDL_EventDispatch {
  public:
    KeyboardDispatch Key;
    MouseDispatch Mouse;
    TextDispatch Text;
    DropDispatch Drop;
    SDL_EventDispatch Shown, Hidden, Exposed, Moved, Resized, SizeChanged, Minimized,
