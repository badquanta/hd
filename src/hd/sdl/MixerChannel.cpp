...
namespace hd::sdl {
  ...
  /** **/
  int
  MixerChannel::FadeOut (int aMs) const
  {
  ...
  /** **/
  bool
  MixerChannel::IsFading ()
  {
    return (FadingStatus () != MIX_NO_FADING);
  }
  /** **/
  bool
  MixerChannel::IsFadingOut ()
  {
    return (FadingStatus () == MIX_FADING_OUT);
  }
  /** **/
  bool
  MixerChannel::IsFadingIn ()
  {
    return (FadingStatus () == MIX_FADING_IN);
  }
  /** **/
  int
  MixerChannel::CountPlaying ()
  {
    return Mix_Playing (-1);
  }
  /** **/
  bool
  MixerChannel::IsPlaying ()
  {
    assert (channel > -2);
  ...
  /** **/
  int
  MixerChannel::CountPaused ()
  {
    return Mix_Paused (-1);
  }
  /** **/
  bool
  MixerChannel::IsPaused ()
  {
